function EFFECT:Init( data )
		...
		if groundtrace.Hit then
			...
			for i = 1,dustsize*0.5 do
				...
				if (particle) then
					...
					particle:SetRoll(math.Rand( 0, 360 ))
					particle:SetColor(math.random(227,227),math.random(211,211),math.random(161,161),math.random(50,50))
					particle:SetGravity( Vector(0,0,dustsize*35*0.5*math.Rand(0.9,1.1)) ) 
					particle:SetAirResistance(dustsize*25*math.Rand(0.9,1.1)) 
					particle:SetCollide(false)
					particle:SetBounce(0)
				end
			end
			for i = 1,dustsize*0.5 do
				...
				if (particle) then
					...
					particle:SetRoll(math.Rand( 0, 360 ))
					particle:SetColor(math.random(227,227),math.random(211,211),math.random(161,161),math.random(50,50))
					particle:SetGravity( Vector(0,0,dustsize*40*0.5*math.Rand(0.9,1.1)) ) 
					particle:SetAirResistance(dustsize*25*math.Rand(0.9,1.1)) 
					particle:SetCollide(false)
					particle:SetBounce(0)
				end
			end
			for i = 1,dustsize*0.25 do
				local ang = math.Rand(0,360) * math.pi/180
				local particle = emitter:Add( "dak/smokey", groundtrace.HitPos+Vector(dustsize*math.Rand(0,0.5)*math.cos(ang),dustsize*math.Rand(0,0.5)*math.sin(ang),-25)) 
				...
				if (particle) then
					...
					particle:SetEndAlpha(0)
					particle:SetStartSize(dustsize*0.125*math.Rand(0.5,2)) 
					particle:SetEndSize((dustsize)*1.25*math.Rand(0.9,1.1))
					particle:SetAngles( Angle(0,0,0) )
					particle:SetAngleVelocity( Angle(math.Rand(-0.5,0.5),0,0) ) 
					particle:SetRoll(math.Rand( 0, 360 ))
					particle:SetColor(math.random(227,227),math.random(211,211),math.random(161,161),math.random(50,50))
					particle:SetGravity( Vector(0,0,dustsize*15*0.5*math.Rand(0.75,1.25)) ) 
					particle:SetAirResistance(dustsize*25*math.Rand(0.9,1.1)) 
					particle:SetCollide(false)
					particle:SetBounce(0)
				end
	...
	--[[
	for i = 1,dustsize*3 do
		local particle = emitter:Add( "dak/smokey", Pos + size*1*Vector( math.random(-1,1),math.random(-1,1),math.random(-1,1) ) ) 
		 
		if particle == nil then particle = emitter:Add( "dak/smokey", Pos + size*Vector(   math.random(0,0),math.random(0,0),math.random(0,0) ) ) end
		if (particle) then
			particle:SetVelocity(5*Vector(math.Rand(-dustsize*100,dustsize*100),math.Rand(-dustsize*100,dustsize*100),math.Rand(-dustsize*100,dustsize*100)))
			particle:SetLifeTime(0) 
			particle:SetDieTime((dustsize/1.5)+math.Rand(0,5))
			particle:SetStartAlpha(200)
			particle:SetEndAlpha(0)
			particle:SetStartSize(15+dustsize*1) 
			particle:SetEndSize((15+dustsize)*10)
			particle:SetAngles( Angle(0,0,0) )
			particle:SetAngleVelocity( Angle(0,0,0) ) 
			particle:SetRoll(math.Rand( 0, 360 ))
			particle:SetColor(math.random(225,225),math.random(225,225),math.random(225,225),math.random(50,50))
			particle:SetGravity( Vector(0,0,10*dustsize) + 1*dustsize*Vector( math.random(-100,100),math.random(-100,100), 0 ) ) 
			particle:SetAirResistance(dustsize*125) 
	...
	for i = 1,3.75*size do
		local ang = math.Rand(0,360) * math.pi/180
		local particle = emitter:Add( "dak/smokey", Pos + size*1*Vector(math.Rand(0,10)*math.cos(ang),math.Rand(0,10)*math.sin(ang),-math.random(-10,10)) ) 
		if particle == nil then particle = emitter:Add( "dak/smokey", Pos + size*Vector(   math.random(0,0),math.random(0,0),math.random(0,0) ) ) end
		if (particle) then
			particle:SetVelocity(size*2.5*Vector(math.random(-30,30),math.random(-30,30),math.random(-20,20)))
			particle:SetLifeTime(0) 
			particle:SetDieTime(smoketime*0.8) 
			particle:SetStartAlpha(200)
			particle:SetEndAlpha(0)
			particle:SetStartSize(size*10) 
			particle:SetEndSize(math.random(1,2)*size*20)
			particle:SetAngles( Angle(0,0,0) )
			particle:SetAngleVelocity( Angle(0,0,0) ) 
			particle:SetRoll(math.Rand( 0, 360 ))
			local CVal = math.random(175,225)
	...
	for i = 1,3.75*size do
		...
		if (particle) then
			...
			particle:SetEndSize(math.random(1,2)*size*50)
			particle:SetAngles( Angle(0,0,0) )
			particle:SetAngleVelocity( Angle(0,0,0) ) 
			particle:SetRoll(math.Rand( 0, 360 ))
			local CVal = math.random(175,225)
