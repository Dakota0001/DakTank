...
function TOOL.BuildCPanel( panel )
	...
	gunList["Autoloader"] = function()
		DLabel:SetText( Caliber.."mm Autoloader\n\nCannons that fire a burst of shells before having to reload. Requires magazine module.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*6.5)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*50))-(math.pi*((Caliber/2)^2)*(Caliber*50)))*0.001*7.8125)/1000).." kg\nRefire Time:  "..math.Round(0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5))*4300,2).." seconds\n\nSmall Mag Stats:\nMag Size:      "..math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5))*4300)*math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))),2).." seconds\n\nMedium Mag Stats:\nMag Size:      "..math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5))*4300)*math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))),2).." seconds\n\nLarge Mag Stats:\nMag Size:      "..math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5))*4300)*math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*13*ShellLength))),2).." seconds\n\n" )
	end
	gunList["Short Autoloader"] = function()
		DLabel:SetText( Caliber.."mm Short Autoloader\n\nCannons that fire a burst of shells before having to reload. Requires magazine module.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*5)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*40))-(math.pi*((Caliber/2)^2)*(Caliber*40)))*0.001*7.8125)/1000).." kg\nRefire Time:  "..math.Round(0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5))*4300,2).." seconds\n\nSmall Mag Stats:\nMag Size:      "..math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*10*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5))*4300)*math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*10*ShellLength))),2).." seconds\n\nMedium Mag Stats:\nMag Size:      "..math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*10*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5))*4300)*math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*10*ShellLength))),2).." seconds\n\nLarge Mag Stats:\nMag Size:      "..math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*10*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5))*4300)*math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*10*ShellLength))),2).." seconds\n\n" )
	end
	gunList["Long Autoloader"] = function()
		DLabel:SetText( Caliber.."mm Long Autoloader\n\nCannons that fire a burst of shells before having to reload. Requires magazine module.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*9)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*70))-(math.pi*((Caliber/2)^2)*(Caliber*70)))*0.001*7.8125)/1000).." kg\nRefire Time:  "..math.Round(0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9))*4300,2).." seconds\n\nSmall Mag Stats:\nMag Size:      "..math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*18*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9))*4300)*math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*18*ShellLength))),2).." seconds\n\nMedium Mag Stats:\nMag Size:      "..math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*18*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9))*4300)*math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*18*ShellLength))),2).." seconds\n\nLarge Mag Stats:\nMag Size:      "..math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*18*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9))*4300)*math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*18*ShellLength))),2).." seconds\n\n" )
	end
	gunList["Autoloading Howitzer"] = function()
		DLabel:SetText( Caliber.."mm Autoloading Howitzer\n\nCannons that fire a burst of shells before having to reload. Requires magazine module.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*4)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*30))-(math.pi*((Caliber/2)^2)*(Caliber*30)))*0.001*7.8125)/1000).." kg\nRefire Time:  "..math.Round(0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4))*4300,2).." seconds\n\nSmall Mag Stats:\nMag Size:      "..math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*8*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4))*4300)*math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*8*ShellLength))),2).." seconds\n\nMedium Mag Stats:\nMag Size:      "..math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*8*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4))*4300)*math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*8*ShellLength))),2).." seconds\n\nLarge Mag Stats:\nMag Size:      "..math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*8*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4))*4300)*math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*8*ShellLength))),2).." seconds\n\n" )
	end
	gunList["Autoloading Mortar"] = function()
		DLabel:SetText( Caliber.."mm Autoloading Mortar\n\nCannons that fire a burst of shells before having to reload. Requires magazine module.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*2.75)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*15))-(math.pi*((Caliber/2)^2)*(Caliber*15)))*0.001*7.8125)/1000).." kg\nRefire Time:  "..math.Round(0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75))*4300,2).." seconds\n\nSmall Mag Stats:\nMag Size:      "..math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*5.5*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75))*4300)*math.floor(0.5*24068.224609375/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*5.5*ShellLength))),2).." seconds\n\nMedium Mag Stats:\nMag Size:      "..math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*5.5*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75))*4300)*math.floor(0.5*81230.265625/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*5.5*ShellLength))),2).." seconds\n\nLarge Mag Stats:\nMag Size:      "..math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*5.5*ShellLength))).." rounds\nReload Time: "..math.Round((0.15*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75))*4300)*math.floor(0.5*192545.796875/(((Caliber*0.0393701)^2)*(Caliber*0.0393701*5.5*ShellLength))),2).." seconds\n\n" )
	end
	gunList["Cannon"] = function()
		DLabel:SetText( Caliber.."mm Cannon\n\nVersatile and reliable guns with high penetration and velocity but high weight.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*6.5)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*50))-(math.pi*((Caliber/2)^2)*(Caliber*50)))*0.001*7.8125)/1000).." kg\nReloads: \n\nAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*5150) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*5150)/25 ) , 1).. "\nHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*5350) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*5350)/25 ) , 1).. "\nHEAT: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550)/25 ) , 1).. "\nHVAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3725) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3725)/25 ) , 1).. "\nHESH: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3450)/25 ) , 1).. "\nATGM: "..math.Round( 0.75*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550)/25 ) , 1).. "\nHEATFS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550)/25 ) , 1).. "\nAPFSDS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*2750) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*2750)/25 ) , 1).. "\nAPHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*5450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*5450)/25 ) , 1).. "\n\n" )
	end
	gunList["Long Cannon"] = function()
		DLabel:SetText( Caliber.."mm Long Cannon\n\nExtended barrel cannon firing higher velocity and higher penetration shells at the cost of shell size and gun weight.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*9)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*70))-(math.pi*((Caliber/2)^2)*(Caliber*70)))*0.001*7.8125)/1000).." kg\nReloads: \n\nAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*5150) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*5150)/25 ) , 1).. "\nHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*5350) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*5350)/25 ) , 1).. "\nHEAT: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*3550)/25 ) , 1).. "\nHVAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*3725) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*3725)/25 ) , 1).. "\nHESH: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*3450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*3450)/25 ) , 1).. "\nATGM: "..math.Round( 0.75*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*3550)/25 ) , 1).. "\nHEATFS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*3550)/25 ) , 1).. "\nAPFSDS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*2750) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*2750)/25 ) , 1).. "\nAPHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*5450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*9)*5450)/25 ) , 1).. "\n\n" )
	end
	gunList["Short Cannon"] = function()
		DLabel:SetText( Caliber.."mm Short Cannon\n\nShort barrel cannon firing lower vel and lower penetration shells to save weight and fit more ammo per crate.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*5)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*40))-(math.pi*((Caliber/2)^2)*(Caliber*40)))*0.001*7.8125)/1000).." kg\nReloads: \n\nAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*5150) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*5150)/25 ) , 1).. "\nHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*5350) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*5350)/25 ) , 1).. "\nHEAT: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*3550)/25 ) , 1).. "\nHVAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*3725) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*3725)/25 ) , 1).. "\nHESH: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*3450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*3450)/25 ) , 1).. "\nATGM: "..math.Round( 0.75*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*3550)/25 ) , 1).. "\nHEATFS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*3550)/25 ) , 1).. "\nAPFSDS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*2750) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*2750)/25 ) , 1).. "\nAPHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*5450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*5)*5450)/25 ) , 1).. "\n\n" )
	end
	...
	gunList["Howitzer"] = function()
		DLabel:SetText( Caliber.."mm Howitzer\n\nLower penetration and velocity than cannons, but also lower weight and better HE.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*4)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*30))-(math.pi*((Caliber/2)^2)*(Caliber*30)))*0.001*7.8125)/1000).." kg\nReloads: \n\nAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*5150) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*5150)/25 ) , 1).. "\nHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*5350) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*5350)/25 ) , 1).. "\nHEAT: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*3550)/25 ) , 1).. "\nHVAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*3725) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*3725)/25 ) , 1).. "\nHESH: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*3450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*3450)/25 ) , 1).. "\nATGM: "..math.Round( 0.75*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*3550)/25 ) , 1).. "\nHEATFS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*3550)/25 ) , 1).. "\nAPFSDS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*2750) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*2750)/25 ) , 1).. "\nAPHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*5450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*4)*5450)/25 ) , 1).. "\n\n" )
	end
	gunList["MG"] = function()
	...
	gunList["Mortar"] = function()
		DLabel:SetText( Caliber.."mm Mortar\n\nLight guns with low damage, penetration, and velocity but low weight and high HE splash radius.\n\nWeapon Stats:\nArmor:          "..(Caliber*5).."mm\nWeight:        "..math.Round(((((Caliber*2.75)*(Caliber*3)*(Caliber*3))+(math.pi*(Caliber^2)*(Caliber*15))-(math.pi*((Caliber/2)^2)*(Caliber*15)))*0.001*7.8125)/1000).." kg\nReloads: \n\nAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*5150) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*5150)/25 ) , 1).. "\nHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*5350) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*5350)/25 ) , 1).. "\nHEAT: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*3550)/25 ) , 1).. "\nHVAP: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*3725) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*3725)/25 ) , 1).. "\nHESH: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*3450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*3450)/25 ) , 1).. "\nATGM: "..math.Round( 0.75*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*6.5)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*3550)/25 ) , 1).. "\nHEATFS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*3550) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*3550)/25 ) , 1).. "\nAPFSDS: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*2750) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*2750)/25 ) , 1).. "\nAPHE: "..math.Round( 0.5*(math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*5450) ,2).." seconds, Loaders: "..math.Max(math.Round( (math.pi*((Caliber*0.001*0.5)^2)*(Caliber*0.001*2.75)*5450)/25 ) , 1).. "\n\n" )
	end
