				...
				if Target.Modern and Target.ColdWar then
					...
					if Target.Cost~=nil then
						if Target.CanSpawn == true then
							...
							ply:ChatPrint("Misc")
							ply:ChatPrint("Best Average Armor: "..(math.Round(Target.ArmorMult*420,2)).."mm, Best Round Pen: "..math.Round(Target.MaxPen,2).."mm, HP/T: "..math.Round(math.Clamp(Target.Gearbox.DakHP,0,Target.Gearbox.MaxHP)/(Target.Gearbox.TotalMass/1000),2)..".")
							ply:ChatPrint("-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-")
						else
